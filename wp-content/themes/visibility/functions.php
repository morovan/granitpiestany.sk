...
/* career position offers */

add_action('init', 'position_offers_post_types');
function position_offers_post_types(){
  $labels = array(
    'name'               => __('Position Offers', 'lang'),
    'singular_name'      => __('Position Offer', 'lang'),
    'add_new'            => __('Create new', 'lang'),
    'add_new_item'       => __('Create new', 'lang'),
    'edit_item'          => __('Edit', 'lang'),
    'view_item'          => __('View', 'lang'),
    ...
    'not_found'          => __('Nothing found', 'lang'),
    'not_found_in_trash' => __('Nothing found', 'lang'),
    'menu_name'          => __('Position Offers', 'lang'),
  );
  $supports = array('title', 'editor', 'thumbnail', 'page-attributes');
  $args = array(
    'labels'             => $labels,
  ...
  flush_rewrite_rules('position', $args);
}

/* videos */

add_action('init', 'videos_post_types');
function videos_post_types(){
  $labels = array(
    'name'               => __('Granit videos', 'lang'),
    'singular_name'      => __('Granit video', 'lang'),
    'add_new'            => __('Create new', 'lang'),
    'add_new_item'       => __('Create new', 'lang'),
    'edit_item'          => __('Edit', 'lang'),
    'view_item'          => __('View', 'lang'),
    ...
    'not_found'          => __('Nothing found', 'lang'),
    'not_found_in_trash' => __('Nothing found', 'lang'),
    'menu_name'          => __('Granit videos', 'lang'),
  );
  $supports = array('title', 'editor', 'thumbnail');
  $args = array(
    'labels'             => $labels,
  ...
  flush_rewrite_rules('video', $args);
}

/* news */

add_action('init', 'horezza_news_post_types');
function horezza_news_post_types(){
  $labels = array(
    'name'               => __('HOREZZA news', 'lang'),
    'singular_name'      => __('HOREZZA news', 'lang'),
    'add_new'            => __('Create new', 'lang'),
    'add_new_item'       => __('Create new', 'lang'),
    'edit_item'          => __('Edit', 'lang'),
    'view_item'          => __('View', 'lang'),
    ...
    'not_found'          => __('Nothing found', 'lang'),
    'not_found_in_trash' => __('Nothing found', 'lang'),
    'menu_name'          => __('HOREZZA news', 'lang'),
  );
  $supports = array('title', 'editor', 'thumbnail');
  $args = array(
    'labels'             => $labels,
    ...
    'show_in_menu'       => true,
    'query_var'          => true,
    'rewrite'            => array('slug' => 'horezza-news'),
    'capability_type'    => 'page',
    'has_archive'        => true,
    'hierarchical'       => true,
  ...
  register_post_type('horezza-news', $args);
  flush_rewrite_rules('horezza-news', $args);
}
