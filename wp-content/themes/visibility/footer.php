    ...
    <div class="container">
      ...
      <div class="row ">
        ...
        <div class="col-md-2 col-sm-2 col-xs-12 ">
          <a href="https://www.facebook.com/Granit-Hotels-914412015308240/" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/images/facebook.png" alt="Facebook" class="footer-facebook"></a>
        </div>
      </div>
